...
class Shoppingtest(unittest.TestCase):
    ...
    def test_for_creating_a_shoppinglist(self):
        ...
        self.assertEqual(current_count + 1, output,
    ...
    def tests_delete_an_unavailable_shoppinglist(self):
        ...
        self.assertEqual(
            2, output, "You can not delete a shopping list that does not exist")
    ...
    def tests_Add_item(self):
        ...
        output = self.shoppings.createitem(
            'muthomi', 'muthomi', 'muthomi@gmail.com')
    ...
    def tests_delete_null_item(self):
        ...
        self.assertEqual(
            2, output, "Cannot Delete an item that does not exist")
    ...
    def test_share_empty_shoppinglistname(self):
        output = self.shoppings.share_Shoppinglist('')
        self.assertEqual(3, output, "Empty shopping lists")

    def test_share_nonexisting_shoppingname(self):
        self.shoppings.Shoppinglists = {}
        output = self.shoppings.share_Shoppinglist('mate')
        self.assertEqual(2, output, "Shopping list does not exist")
